...
<aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div className="h-full px-3 py-4 overflow-y-auto bg-purple-300 border-purple-400 border-solid border-2 rounded-r-3xl dark:bg-gray-800">
      <a href="home" className="flex items-center pl-2.5 mb-5">
      ...
      <ul className="space-y-2 font-medium">
         <li>
            <a href="postagens" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-purple-200 dark:hover:bg-gray-700 group">
         ...
         {/* SOBRE */}
         {<li>
            <a href="sobre" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-purple-200 dark:hover:bg-gray-700 group">
