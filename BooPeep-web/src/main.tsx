...
import ProtectedRoute from './ProtectedRoute.tsx'; // O componente ProtectedRoute que definimos anteriormente
...
const router = createBrowserRouter([
  ...
  {
    path: 'postagens',
    element: <ProtectedRoute path="/postagens" isAuthenticated={isAuthenticated}><Postagens /></ProtectedRoute>,
  },
  {
    path: 'sobre',
    element: <ProtectedRoute path="/sobre" isAuthenticated={isAuthenticated}><Sobre /></ProtectedRoute>,
  },
  {
    path: 'test',
    element: <Droptest />,
